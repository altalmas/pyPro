"""
This file works very good 

From: 
    https://maker.pro/nvidia-jetson/tutorial/streaming-real-time-video-from-rpi-camera-to-browser-on-jetson-nano-with-flask
    
You can access the video feed in a browser window on any device
connected on the same network by accessing the IP address.
For example, type in 10.8.1.8:8000 and you can see the live stream.
"""
